...
const calendarService = {
  ...
  removeSeatsForCalendar(calendarSid, data) {
    ...
    //Initially assume that we need to remove all the seats
    ...
    return appointmentService
      ...
      .then((appointmentData) => {
        ...
        //Filter out the seat that have appointments against them
        ...
        //If there are more seats without appoint than the numberOfSeatsToRemove
        if (deletionList.length >= numberOfSeatsToRemove) {
          ...
          //If we need to remove seats with appointment
          //Get a chunk of seats with appointment and concat them with the deletion list
